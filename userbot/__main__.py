...
print(f"""DeadlyGhouls IS ON!!! DeadlyGhouls VERSION :- {deadlyversion} YOUR ∂єα∂ℓу gнσυℓѕ IS READY TO USE! FOR CHECK YOUR BOT WORKING OR NOT PLEASE TYPE (.alive/.ping) ENJOY YOUR BOT! JOIN FOR MORE FUTURE UPDATES @DEADLY_TECHY .""")
    ...
    try:
        if Config.PM_LOGGR_BOT_API_ID != 0:
            await bot.send_file(
                ...
                DEADLY_GHOULS_PIC,
                caption=f"༆ʟɛɢɛռɖaʀʏ ᴀғ ∂єα∂ℓу gнσυℓѕ༆\n\n**𝚅𝙴𝚁𝚂𝙸𝙾𝙽 ➪ {deadlyversion}**\n\n𝐓𝐲𝐩𝐞 `.ping` or `.alive` 𝐭𝐨 𝐜𝐡𝐞𝐜𝐤! \n\n𝙹𝙾𝙸𝙽 [DeadlyGhouls 𝙲𝙷𝙰𝚃](t.me/DeadlyGhouls_CHIT_CHAT) 𝚃𝙾 𝚀𝚄𝙴𝚁𝚈 & 𝙹𝙾𝙸𝙽 [𝙼𝙰𝙵𝙸𝙰 𝚄𝙿𝙳𝙰𝚃𝙴𝚂](t.me/DEADLY_TECHY) 𝚃𝙾 𝙺𝙽𝙾𝚆 𝚁𝙴𝙶𝚁𝙰𝙳𝙸𝙽𝙶 𝚄𝙿𝙳𝙰𝚃𝙴 𝙰𝙽𝙳 𝙽𝙴𝚆𝚂 𝙰𝙱𝙾𝚄𝚃 DeadlyGhouls",
            )
