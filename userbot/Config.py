...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "DeadlyGhouls")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/Deadly-fighters/DEADLY-GHOULS-BOT"
        )
        ...
        EXTRA_DeadlyGhouls = os.environ.get("EXTRA_DeadlyGhouls", -1001221881562)
