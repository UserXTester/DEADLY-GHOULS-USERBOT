...
@DeadlyGhouls.on(admin_cmd(pattern="sin ?(.*)"))
@DeadlyGhouls.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@DeadlyGhouls.on(admin_cmd(pattern="cos ?(.*)"))
@DeadlyGhouls.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@DeadlyGhouls.on(admin_cmd(pattern="tan ?(.*)"))
@DeadlyGhouls.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@DeadlyGhouls.on(admin_cmd(pattern="cosec ?(.*)"))
@DeadlyGhouls.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@DeadlyGhouls.on(admin_cmd(pattern="sec ?(.*)"))
@DeadlyGhouls.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@DeadlyGhouls.on(admin_cmd(pattern="cot ?(.*)"))
@DeadlyGhouls.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@DeadlyGhouls.on(admin_cmd(pattern="square ?(.*)"))
@DeadlyGhouls.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@DeadlyGhouls.on(admin_cmd(pattern="cube ?(.*)"))
@DeadlyGhouls.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
