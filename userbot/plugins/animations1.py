...
async def _(event):
    ...
    await edit_or_reply(event, "deadlyo")
    animation_chars = [
        "Indian Flag",
...
async def _(event):
    ...
    animation_chars = [
        ...
        "`Call Connected.`",
        "`Secretary: deadlyo This is Raj Bhawan. Who is this?`",
        f"`Me: deadlyo this is` `{DEFAULUSER}` .Please connect me to Prime Minister",
        "`User Authorised.`",
        "`Calling`  `At +9189*#*#*#56`",
        "`Private  Call Connected...`",
        "`Me: deadlyo Sir, How are you!!`",
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1212368262:
            await event.edit(
                "This is My Master\n**How dare you trying to tell me to kill master nigger!**\n\n__Your account is on hold! Pay 99$ to my master__ [Himanshu](https://t.me/OFFICIAL_SAMEER) __to release your account__😏"
            )
        else:
