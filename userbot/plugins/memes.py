...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/Deadly-fighters/DEADLY-GHOULS-BOT) to open this 🔥**Lit AF!!**🔥 __DeadlyGhouls__ Repo.. Join channel :- @DEADLY_TECHY")
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the deadly" + "ツ")
